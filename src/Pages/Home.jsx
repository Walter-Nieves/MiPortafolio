...
import { openCvPdf } from "../utils/OpenCvPdf.jsx";

function Home() {
  const { contenido,language } = useContext(LanguageContext);
        ...
        <div className="info">
          <div className="text">
            ...
            <div className="btn-separator">
              <button type="button"  onClick={()=> openCvPdf(contenido,language)} >{contenido.inicio.boton1}</button>
              <Link to="/contacto">
