export const datos = {
  ...
  inicio: {
    saludo: "Hola bienvenido! Soy",
    nombre: "Walter Nieves A",
  ...
  proyecto: {
    ...
    proyectos: [
      ...
      },
      {
        ...
        demonstracion: "https://walter-nieves.github.io/Amigo-secreto/",
        repositorio: "https://github.com/Walter-Nieves/Amigo-secreto",
      },
      {
      ...
      },
      {
        ...
        demonstracion: "https://walter-nieves.github.io/Juego-del-ahorcado/",
        repositorio: "https://github.com/Walter-Nieves/Juego-del-ahorcado",
      },
      {
        nombre: "Tasklist",
        descripcion:
      ...
      },
      {
        ...
        descripcion:
          "Poder mostrar lo que me gusta hacer y me apasiona en este proyecto que me gustó bastante",
        foto: "/MiPortafolio/imagenes/miportafolio.webp",
        demonstracion: "https://walter-nieves.github.io/MiPortafolio/",
        repositorio: "https://github.com/Walter-Nieves/MiPortafolio",
      },
    ],
  },
  contacto: {
    titulo: "Contacto",
    parrafo:
      "Completa el siguiente formulario para ponerte en contacto conmigo",
    nombre: "Nombre",
    correo: "Correo",
    asunto: "Asunto",
    mensaje: "Mensaje",
    boton: "Enviar",
    errores: {
      requerido: "Debes llenar este campo",
      minimo: "Debes tener mínimo 5 caracteres",
      minimo2: "Debes tener mínimo 2 caracteres",
      maximo: "Debes tener máximo 40 caracteres",
...
export const datos2 = {
  ...
  contacto: {
    titulo: "Contact",
    parrafo: "Complete the following form to contact me",
    nombre: "Name",
    correo: "Mail",
    asunto: "Case",
    mensaje: "Message",
    ...
    errores: {
      ...
      minimo: "Must be at least 5 characters",
      minimo2: "Must be at least 2 characters",
      maximo: "Must be no more than 10 characters",
      maximo2: "Must be no more than 40 characters",
      maximo3: "Must be no more than 400 characters",
      invalidoCorreo: "The entered email is not valid",
      notAllowed1: "Characters < and > are not allowed",
      notAllowed2: "Numbers are not allowed",
